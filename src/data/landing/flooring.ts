...
export const flooringLanding: LandingPage = {
  ...
  hero: {
    ...
    formByline:
      "Tell us roughly which rooms and what's down now. We'll get back to you to schedule a walkthrough — usually within one business day.",
    formName: "flooring-lead",
    submitLabel: "Request my free estimate",
    projectTypes: [
      "Hardwood — new install",
      "Replace carpet with hardwood or LVP",
      "LVP or laminate",
      "Tile — kitchen, bath, or entry",
      "Whole main floor or whole house",
      "Stairs",
